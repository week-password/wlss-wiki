...
Необязательный атрибут **Желания**. Используется для хранения, отображения и загрузки картинки **Желания**. Представляет из себя картинку в одном из форматов - `png`, `jpg`, `jpeg`. Размер файла картинки должен быть не больше 10-ти мегабайт. Длина имени файла не должна превышать 255 символов (т.к. большинство файловых систем имеют такое ограничение, см [ссылку](https://en.wikipedia.org/wiki/Comparison_of_file_systems#Limits)).
